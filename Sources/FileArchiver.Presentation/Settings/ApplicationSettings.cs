...
namespace FileArchiver.Presentation.Settings
{
	...
	/// </summary>
	/// <remarks>
	/// As opposed to the Settings class generated by visual studio designer, settings from this class
	/// can be shared between multiple assemblies.
	/// </remarks>
	[Serializable]
	public class ApplicationSettings
	{
		...
		private static string ConfigFilePath
		{
			get
			{
				...
				var appNameAttribute = Assembly.GetExecutingAssembly().GetCustomAttribute(typeof(AssemblyProductAttribute))
				                       as AssemblyProductAttribute;
				var applicationName  = appNameAttribute.Product;

				return Path.Combine(localAppData, applicationName, "config.xml");
			}
		}
	}
}
