...
namespace FileArchiver.Presentation.Tests.PerFileErrorHandlers
{
	...
	internal class FileAddingPerFileErrorPresenterTests
	{
		...
		public void SetUp()
		{
			...
			mTestedPresenter = new FileAddingPerFileErrorPresenter(mViewMock, mArchiveMock, mFileNameGeneratorMock,
			                                                       new NullSynchronizationContext());
		}

		[Test]
		public void WhenUnhandledExceptionIsPassed_DoNothing()
		{
			...
			A.CallTo(mArchiveMock).MustNotHaveHappened();
		...
		[Test]
		public void WhenFileExistsExceptionIsPassedTellThatFileExistsAndAskWhatToDo()
		{
			var destinationPath = new Path("DestinationFile");
		...
		[Test]
		public void WhenFileExistsAndUserChooseAbort_ExceptionThrownReturnsAbort()
		{
			var destinationPath = new Path("DestinationFile");
		...
		public void WhenFileExistsAndUserChooseOverwrite_DeleteTheFileAndTellTheCallerToRetry()
		{
			...
			A.CallTo(() => mArchiveMock.RemoveFile(destinationPath)).MustHaveHappened();
			Assert.That(actionToPerform, Is.EqualTo(RetryAction.Retry));
		}
